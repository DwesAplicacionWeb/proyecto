...
Class ValidadorForm{
     ...
     * @return	void
     */
    public function validar($fuente , $reglasValidacion){  //Valida todos los campos 
        $aux = 0;
     ...
     * @return	void
     */
    public function addError($nombreCampo , $error){  // Añade un error al array de errores
     ...
     * @return	mixed
     */
    public function esValido(){  // Devuelve true si es válido
     ...
     * @return	mixed
     */
    public function getErrores(){  // Devuelve el array de errores
        return $this->errores;
    }
     ...
     * @return	void
     */
    public function getMensajeError($campo){  // Devuelve un error
